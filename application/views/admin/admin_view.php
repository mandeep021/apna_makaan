...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="#" class="current">Admin</a> </div>
    <h1>Admin</h1>
  </div>
                ...
                <?php 
                  foreach ($admin as $key => $value) {
                    echo '<tr>
                            ...
                            <td class="center">
                              <a href="'.ADMIN_URL.'edit_admin/'.$value["_id"].'">Edit</a> | <a href="'.ADMIN_URL.'delete_admin/'.$value["_id"].'/'.($value["status"] == 2?1:2).'">'.($value["status"] == 2?'Active':'Delete').'</a>
                            </td>
                          </tr>';
                  }
                ?>
